...
def objective(trial):
    lr = trial.suggest_categorical('lr', [1.e6])
    look_ahead_lr = trial.suggest_categorical('look_ahead_lr', [0.01])
    l2_reg = trial.suggest_categorical('l2_reg', [1.e-2])
    set_seed(2023)
    ...
    attacker_config = {'name': 'FLOJOAttacker', 'n_fakes': 131, 'topk': 50, 'n_inters': 41,
                       ...
                       'look_ahead_lr': look_ahead_lr, 'look_ahead_first_rate': 10, 'look_ahead_step': 2, 'train_fake_its': 5,
